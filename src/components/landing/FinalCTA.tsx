...
const FinalCTA = ({
  ...
  return <section className="py-20 px-4 gradient-hero relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          Pronto para <span className="text-gradient">acelerar com a Mentoria</span>?
        </h2>
        ...
        <ShinyButton className="text-xl px-12 py-8" onClick={handleFormClick}>
